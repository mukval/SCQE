    ...
    <tr style="display:none" id="trMulti">
        <td align="center">
            <table class="desc_text" id="tblMulti" >
                <tr>
                    <td>Заголовок (Не обязательно):</td>
                ...
                <tr>                    
                    ...
                    <td class="desc_text">Правильный ответ </td>
                </tr>
    ...
    <tr style="display:none" id="trArea">
        <td align="center">
            <table id="tblArea" class="desc_text">
                ...
                <tr>
                    <td valign="top" align="right">
                        Введите правильный ответ (Не обязательно): 	
                     </td>
                    <td>
            ...
            <table id="tblMultiText" class="desc_text">
             ...
             <table width="320px">
              ...
              <table style="display:none">
                <tr>
                    <td><input type="checkbox" id="chkAllowNumbers" name="chkAllowNumbers" /><label id="lbl1" for="chkAllowNumbers">Разрешить вводить только цифры</label></td>
                </tr><tr>
                    <td><input type="checkbox" id="chkDontCalc" name="chkDontCalc" /><label id="lbl1" for="chkDontCalc">Не считать результат этого вопроса</label></td>
                </tr>
            </table>
        </td>
    </tr>
