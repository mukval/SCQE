...
access::allow("1");
 ...
 $val->AddValidator("drpCats", "notequal", "Выберите категорию", "-1");
 $val->AddValidator("drpTests", "notequal", "Выберите тест", "-1");
 $val->AddValidator("txtSuccessP", "empty", "Введите проходной бал","");
 $val->AddValidator("txtTestTime", "empty", "Введите время теста","");
...
$hedaers = array("&nbsp;","Логин",  "Имя","Фамилия", "Email");
...
$hedaers_imp = array("&nbsp;","Логин",  "Имя","Фамилия");
...
if(isset($_POST["btnSave"]) && $val->IsValid())
{
    ...
    try
    {
        ...
        else
        {
             ...
             //echo quizDB::DeleteQuizByIdQuery($selected_test);
             $quiz_id = CopyQuiz($org_quiz_id);
