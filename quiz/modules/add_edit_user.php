...
access::allow("1");
    ...
    $val->AddValidator("txtLogin", "empty", "Логин не может быть пуст","");
    $val->AddValidator("txtPassword", "empty", "Пароль не может быть пуст","");
    $val->AddValidator("drpUserType", "notequal", "Укажите тип", "-1");
    ...
    function desc_func()
    {
        return "Добавить/Изменить пользователя ";
    }
